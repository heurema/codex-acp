...
[Submit a PR](https://github.com/heurema/codex-acp/pulls) to add yours!

#### Installation

Install the adapter from the latest release for your architecture and OS: https://github.com/heurema/codex-acp/releases
